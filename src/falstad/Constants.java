...
public class Constants {
	...
	public static int[] SKILL_X =     { 4, 12, 15, 20, 25, 25, 35, 35, 40, 60, 70, 80, 90, 110, 150, 300 }; // width
	public static int[] SKILL_Y =     { 4, 12, 15, 15, 20, 25, 25, 35, 40, 60, 70, 75, 75,  90, 120, 240 }; // height
    ...
    // Possible keypresses that lead to actions in controller
    public enum KeyPress {
        UP, LEFT, RIGHT, DOWN, // correspond to directions of movement
        ESC, // corresponds to pressing escape key
        WALL_PHASE, //corresponds to pressing ctrl+'w'
        FULL_MAZE, // corresponds to pressing '/t' or 'm'
        SHOW_MAZE, // corresponds to pressing 'z'
        SHOW_SOLUTION, // corresponds to pressing 's'
        ZOOM_IN, // corresponds to pressing '+' or '='
        ZOOM_OUT, // corresponds to pressing '-'
    }

	public enum Colors { WHITE, GRAY, RED, YELLOW , BLACK, DARK_GRAY }
