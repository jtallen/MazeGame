...
public class PledgeTest {
    ...
    /**
     * Tests Pledge.getPathLength() for before and after
    ...
    public final void testPathLength() {
        ...
        assertTrue(reachedExit); // should never get hung up, so will always complete skill 3 maze
    ...
    public final void testRobot() {
        ...
        testDriver = (Pledge) this.controller.getDriver();
